...
|---|---|---|---|
| 1 | 2A202600273 | Phạm Việt Anh | Phân tích |
| 2 | 2A202600371 | Hoàng Đức Nghĩa | Phân tích |

---

## Nhiệm vụ thử nghiệm chung

So sánh khả năng tìm kiếm và tổng hợp thông tin của Gemini và ChatGPT thông qua yêu cầu: Nêu ít nhất 5 số liệu/sự kiện cụ thể (có nguồn và ngày), so sánh vai trò của AI chatbot với Google Search, chỉ ra rủi ro và đưa ra kết luận cho sinh viên khi làm nghiên cứu học thuật.

**Ngành chọn**: A — Tìm kiếm

**Sản phẩm A**: Gemini (https://gemini.google.com)

**Sản phẩm B**: ChatGPT (https://chat.openai.com)

---

## Phân chia screenshot

- Sản phẩm A → Phạm Việt Anh
- Sản phẩm B → Hoàng Đức Nghĩa
